...
We bekomen dus polygonen voor elke landbouwstreek in Vlaanderen[^uitrol_meetnet-1].
...
-   Langs alle paden worden op regelmatige afstanden van 50 m punten gelegd[^uitrol_meetnet-2].
...
[^uitrol_meetnet-1]: Met uitzondering van de Duinen en de Weidestreek.
    Deze worden apart besproken in Sectie \@ref(overige-streken).

[^uitrol_meetnet-2]: Bij de steekproeftrekking wordt een methode gebruikt die zal vermijden dat telpunten en hun telcirkels overlappen.
