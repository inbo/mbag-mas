...
\textcolor{red}{rest van data op zenodo enzo}
...
Deze zijn apart geanalyseerd omdat het niet mogelijk is een voldoende grote steekproef te verkrijgen op eenzelfde wijze als beschreven in \@ref(meetnet-ontwerp).
...
\begin{figure}
  ...
  \caption{Afbakening van het steekproefkader in de landbouwstreek van de Duinen. Selectie van open en halfopen landschap binnen de perimeter (rood). Exclusie van landgebruiken op basis van OpenStreetMap data (groen). Selectie van paden en wegen (blauw). \textbf{A.} Westkant (xmin = 21500, xmax = 50000, ymin = 197000, ymax = 217000). \textbf{B.} Oostkant (xmin = 50000, xmax = 82000, ymin = 213000, ymax = 230000).}
...
\end{figure}
```
Bijgevolg hebben we in de Weidestreek wel een voldoende grote, ruimtelijk gebalanceerde steekproef kunnen waarvan punten niet overlapten binnen eenzelfde stratum.
De proporties van de strata kwamen bovendien niet meer goed overeen met de allocatieproporties.
...
We besluiten in de Weidestreek wel een steekproef te nemen zoals beschreven in \@ref(meetnet-ontwerp) met het verschil dat we hier een allocatie gebruikten evenredig aan de oppervlakte van elk stratum.
