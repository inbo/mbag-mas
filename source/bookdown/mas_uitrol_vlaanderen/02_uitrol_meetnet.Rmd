...
\begin{figure}
  ...
  \caption{Afbakening van het steekproefkader in de landbouwstreek van de Duinen. Selectie van open en halfopen landschap binnen de perimeter (rood). Exclusie van landgebruiken op basis van OpenStreetMap data (groen). Selectie van paden en wegen (blauw). \textbf{A.} Westkant (xmin = 150000, xmax = 177000, ymin = 160000, ymax = 180000). \textbf{B.} Oostkant (xmin = 150000, xmax = 177000, ymin = 160000, ymax = 180000).}
  \label{fig:afbakening-duinen}
\end{figure}
```
Langs deze paden werden punten gelegd die bijgevolg werden gefilterd op basis van landgebruik en zichtbaarheid zoals beschreven in \@ref(meetnet-ontwerp).
In het overgebleven steekproefkader merkten we een sterke spatiale clustering van punten in zijn geheel (enkel punten in regio Nieuwpoort en Knokke) en binnen eenzelfde stratum (Fig. \@ref(fig:steekproefkader-duinen)).
...
\end{figure}
```
Bijgevolg hebben we in de Duinen een steekproef van slechts 13 punten kunnen nemen die niet overlappen binnen eenzelfde stratum.
...
Langs deze paden werden punten gelegd die bijgevolg werden gefilterd op basis van landgebruik en zichtbaarheid zoals beschreven in \@ref(meetnet-ontwerp).
In het overgebleven steekproefkader merkten we een sterke spatiale clustering van punten binnen eenzelfde stratum, maar met een veel betere spreiding van de punten in het volledige gebied (Fig. \@ref(fig:steekproefkader-weidestreek)).

Bijgevolg hebben we in de Weidestreek wel een voldoende grote steekproef nemen waarvan punten niet overlapten binnen eenzelfde stratum.
De proporties van de strata kwamen bovendien niet meer goed overeen met de allocatieproporties.
