...
filtered_distance_df %>%
  ...
  labs(x = "Telperiode", y = "Aantal broedparen", fill = "Broedcode", title = params$year)
```
...
filtered_distance_df %>%
  ...
  geom_bar() +
  facet_wrap(~regio, scales = "free") +
  labs(x = "Telperiode", y = "Aantal broedparen", fill = "Stratum", title = params$year)
```
...
filtered_distance_df %>%
  ...
  geom_histogram() +
  facet_wrap(~regio, scales = "free") +
  labs(x = "Afstand (m)", y = "Aantal broedparen", fill = "Stratum", title = params$year)
```
...
We controleren even of dit hetzelfde is als verderop:
