...
# Downloaden van de data via Sovon WFS service

Data wordt geïmporteerd via [QGIS](https://qgis.org/).
...
1.  Maak een verbinding met de zopas toegevoegde WFS service
    ...
    1.   Klik op Verbinden
    1.   Geef je gebruikersnaam en paswoord wanneer dit wordt gevraagd en klik op ok
