...
targets_store <- here("source", "targets", "mas_steekproef_za_kp_po", "_targets")
```
...
mapview(st_crop(perimeters_data, detail),
  ...
  mapview(st_crop(paden, detail), legend = FALSE) +
  mapview(st_crop(exclusie_punten, detail), col.regions = "black",
          legend = FALSE)
```
...
```{r, eval=FALSE}
kempen_avimap_df <- read_delim(file.path(
  "data",
  "processed",
