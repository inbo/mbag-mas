...
map_taxa_from_vernacular(
  vernacular_name_df = vernacular_names_df,
...
Voor Vink en Haas vinden we bv. geen soortnaam die matched.
Voor Merel bv. is er ook geen mogelijkheid om automatisch de juiste naam te selecteren (zelfs als je een filter voor Aves zou inbouwen).
...
test <- rgbif::name_lookup(
  "Merel",
  datasetKey = "d7dddbf4-2cf0-4f39-9b2a-bb099caae36c",
  rank = "SPECIES",
  higherTaxonKey = 1)

df_name <- find_df_name(test$names, "Merel")
