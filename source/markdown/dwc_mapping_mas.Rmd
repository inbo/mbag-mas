...
De soortcodes in `dwc_taxonID` zijn Avimap-codes.
...
We zijn niet tevreden met eerste beste match, maar gaan met een specifieke regex door meerdere namen zoeken (Gele Kwikstaart zal bv. niet met Grote Gele Kwikstaart matchen en Merel zal bv. ook niet met Indische Merel matchen).
...
- Zijn variabelen relevant om mee te geven?
  ...
  - `raw_periode_in_jaar`: 1 van 4 telperiodes --> optioneel laat dit temporele dataveld toe om alle tellingen (events) in een jaar te groeperen per telperiode (als `parentEvent`)
...
col_order <- c(
  ...
  # "datasetID", "collectionCode", "institutionCode",
