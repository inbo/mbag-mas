...
- We kunnen ook afwezigheiden toevoegen (`dwc_occurrenceStatus = "absent"` en `dwc_individualCount = 0`) aangezien alle vogels worden genoteerd op het moment van tellen vanaf dat telpunt. Hoe doen we dit?
...
- Volgorde van de kolommen aanpassen
- Hoe kunnen we de wetenschappelijke namen bekomen?
