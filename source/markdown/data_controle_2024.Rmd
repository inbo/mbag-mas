...
We zien dat sommige punten in bepaalde jarne niet geteld zijn:
...
- nooit geteld (2022-2024)
- steekproef beslissing: zou ter vervanging zijn van Ol_11054.15 en Ol_3417.2

Ol_5760.2.14

- nooit geteld (2022-2024)
- steekproef beslissing: zou ter vervanging zijn van Ol_513.1
...
- nooit geteld (2022-2024)
- steekproef beslissing: zou ter vervanging zijn van Ol_22546.2
...
inside_observations_problems <- calculate_obs_distance %>%
  filter((plotnaam == "Ol_1901.4" & jaar == 2022 & periode_in_jaar != "R2") |
...
mas_data_clean %>%
  ...
  select("oid", "plotnaam", "x_lambert", "y_lambert", "datum", "periode_in_jaar", "jaar",
         "naam", "aantal", "broedcode", "waarnemer") %>%
