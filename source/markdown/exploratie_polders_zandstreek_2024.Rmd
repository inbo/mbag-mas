...
save_figure(p, here(media_folder, "aantal_soorten_vogels_strat_pl_zn_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "waarnemingen_zoogdieren_pl_zn_2024"), devices,
  dpi = 300, width = 8, height = 6
)
