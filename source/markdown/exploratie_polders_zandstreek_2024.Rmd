...
media_folder <- here("media", "exploratie_2024")
...
write_csv(summary_vogels_2024, here(media_folder, "summary_vogels_2024.csv"))
...
save_figure(p, here(media_folder, "tellingen_vogels_2024"), devices,
...
save_figure(p, here(media_folder, "soorten_vogels_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "waarnemingen_vogels_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "cum_soorten_vogels_2024"), devices,
...
save_figure(p, here(media_folder, "aantal_soorten_vogels_strat_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "vogelfreqs_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "vogelfreqs_diff_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "vogelfreqs_ratio_zn_lm_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "vogelfreqs_ratio_lm_zn_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "vogelfreqs_2024_doelsoorten"), devices,
...
write_csv(summary_zoogdieren_2024,
          here(media_folder, "summary_zoogdieren_2024.csv"))
...
save_figure(p, here(media_folder, "waarnemingen_zoogdieren_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "cum_soorten_zoogdieren_2024"), devices,
  dpi = 300, width = 8, height = 8
)
```
...
save_figure(p, here(media_folder, "zoogdierfreqs_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "zoogdierfreqs_diff_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "aantal_hazen_2024"), devices,
  dpi = 300, width = 8, height = 6
)
...
save_figure(p, here(media_folder, "relfreq_haas_2024"), devices,
  dpi = 300, width = 8, height = 6
)
