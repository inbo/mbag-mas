...
test_dist_df <- mas_telperiodes %>%
  ...
  summarise(afval_n = sum(test_var),
...
test_dist_df %>%
  ggplot() +
    ...
    labs(x = "Aantal waarnemingen die wegvallen per telpunt per telperiode",
         y = "Frequentie")
```
...
test_dist_df %>%
  ...
  ggplot() +
    ...
    labs(x = paste("Proportie aantal waarnemingen die wegvallen",
                   "per telpunt per telperiode", sep = "\n"),
         y = "Frequentie")
```
...
ggsave(here(media_folder, "tellingen_vogels_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "soorten_vogels_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "waarnemingen_tot_vogels_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "waarnemingen_vogels_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "cum_soorten_vogels_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 8)
...
ggsave(here(media_folder, "aantal_soorten_vogels_strat_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "vogelfreqs_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "vogelfreqs_diff_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "vogelfreqs_2023_doelsoorten.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 7)
...
ggsave(here(media_folder, "waarnemingen_tot_zoogdieren_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "cum_soorten_zoogdieren_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 8)
...
write_csv(relfreq_zoogdieren_regio,
...
ggsave(here(media_folder, "zoogdierfreqs_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
write_csv(relfreqs_zoogdieren_diff,
...
ggsave(here(media_folder, "zoogdierfreqs_diff_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "aantal_hazen_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "relfreq_haas_2023.pdf"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
